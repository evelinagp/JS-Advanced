class Movie {
    ...
    newScreening(date, hall, description) {
        ...
        /*  calculate the current screening profit of sold ticketsCount, add the 
            profit to the total profit for the movie, 
            also add the sold ticketsCount count to the total sold movie
            tickets, delete the screening from the screenings array and screenings.clear();*/
    endScreening(date, hall, ticketsCount) {
        ...
        const profit = this.ticketPrice * ticketsCount;

        this._revenue += profit;
        this._ticketsSold += ticketsCount;
