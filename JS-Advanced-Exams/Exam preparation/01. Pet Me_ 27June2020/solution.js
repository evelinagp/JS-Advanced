function solve() {
    // get references to elements of intrest
    ...
    function addPet(event) {
        ...
        function contact() {
            const confirmationInput = e('input', { placeholder: 'Enter your names' });
            const confirmationBtn = e('button', {}, 'Yes! I take it!');
            const confirmationDiv = e('div', {}, confirmationInput, confirmationBtn);
    ...
    //Configure eventListener for new button
    //Replace confirmationDiv with new button
    //Cahnge text content of Owner span
